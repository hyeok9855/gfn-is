...
Note that this work is a prequel to "[Reinforced sequential Monte Carlo for amortised sampling](https://arxiv.org/abs/2510.11711)" (ICML 2026 spotlight, [code](https://github.com/hyeok9855/ReinforcedSMC)), which incorporates sequential Monte Carlo (SMC) in addition to the importance-weighted buffer.
