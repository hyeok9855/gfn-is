...
DEFAULT_ARGS="--energy_name aldp_fab --loss_type tb --init_log_Z iw_elbo --epochs 30000 --hidden_dim 1024 --joint_layers 2 --eval_data_size 2000 --final_eval_data_size 100000 --no_full_eval"
...
DEFAULT_ARGS_PIS="--energy_name aldp_fab --loss_type pis --epochs 30000 --hidden_dim 1024 --joint_layers 2 --eval_data_size 2000 --final_eval_data_size 100000 --no_full_eval"
