...
DEFAULT_ARGS="--energy_name gmm40 --ndim 2 --epochs 15000 --hidden_dim 256 --joint_layers 2 --batch_size 300 --eval_data_size 2000 --final_eval_data_size 10000"
DIFFUSION="--t_scale 100.0 --T 50 --eval_T 100 --discretizer equidistant"
